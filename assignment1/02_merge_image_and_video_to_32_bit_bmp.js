...
const bmp = fs.readFileSync('./out1.bmp')
const wav = fs.readFileSync('./in.wav')
...
for (let i = 0; i < imageData.length; i++) {
  mergedData.push(imageData[i])
  mergedData.push(wavData[i])
}
...
// Write file to disc
fs.writeFileSync('out2.bmp', buff)
